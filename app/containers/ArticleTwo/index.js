...
export default class ArticleTwo extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <div>
        <Helmet title="ArticleTwo" meta={[ { name: 'description', content: 'Description of Home' }]}/>
              ...
              <div style = {backgroundContentBox}>
                <div style = {contentHolder}>
                  ...
                  <div style = {contentTitle}>
                    Ophuls's goes to the circus in his first color film
                  </div>

                  <img style = {articleImage} src="https://houseofmirthandmovies.files.wordpress.com/2011/03/lol.png" alt=""/>
            ...
            <div style = {backgroundStyleMobile }>
              ...
              <div style = {backgroundContentBoxMobile }>
                <div style = {contentHolderMobile }>
                  ...
                  <img style = {articleImageMobile } src="https://houseofmirthandmovies.files.wordpress.com/2011/03/lol.png" alt=""/>
